...
// Store the result in a variable called sealedStatus.
const sealedStatus = Object.isSealed(teacher);

// f) Print the extensibleStatus and sealedStatus to the console.
console.log('Extensible Status of student:', extensibleStatus); // Should print: false
console.log('Sealed Status of teacher:', sealedStatus); // Should print: true